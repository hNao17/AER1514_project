...
int main(int argc, char** argv)
{
    ...
    ROS_INFO_STREAM("Final Postion x ="<<x_current<<" y ="<<y_current);
...
void readWaypoints()
{
    ...
    infile.open("/home/venu/catkin_ws/src/AER1514_project/walle/src/scripts/waypoint_textfiles/master_waypoints_final_nms.csv");
